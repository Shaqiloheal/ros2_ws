...
static const _MonitorError_type_support_symbol_names_t _MonitorError_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rosmonitoring_interfaces, msg, MonitorError)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rosmonitoring_interfaces, msg, MonitorError)),
  }
};
...
{
  return &::rosmonitoring_interfaces::msg::rosidl_typesupport_cpp::MonitorError_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, rosmonitoring_interfaces, msg, MonitorError)() {
  return get_message_type_support_handle<rosmonitoring_interfaces::msg::MonitorError>();
}
